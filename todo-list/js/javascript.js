...
const createTask = (taskinputValue) => {
    ...
    const buttonFinish = createElement("button", "finish", '<i class="fa-solid fa-check finish">');
    taskDiv.appendChild(buttonFinish)
    
    const buttonEdit = createElement("button", "edit", '<i class="fa-solid fa-pen edit"></i>');
    taskDiv.appendChild(buttonEdit)
    
    const buttonRemove = createElement("button", "remove", '<i class="fa-solid fa-xmark remove"></i>');
